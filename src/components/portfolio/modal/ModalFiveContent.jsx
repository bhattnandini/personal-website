...
const ModalFiveContent = () => {
  return (
    ...
    <figure>
      ...
      <img src="https://assets.appstasy.in/nandinee/certificates/yellow_belt.png" alt="Nandini Bhatt's Lean Six Sigma Yellow Belt certification,Software Tester, QA, Cloud, DevOps, Automation, AWS, Agile" />
      {/* <Slider {...settings}>
