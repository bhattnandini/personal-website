...
const ModalSixContent = () => {
  return (
    ...
    <figure>
      ...
      <img src="https://assets.appstasy.in/nandinee/certificates/green_belt.png" alt="Nandini Bhatt's Lean Six Sigma Green Belt certification, Software Tester, QA, Cloud, DevOps, Automation, AWS, Agile" />
      {/* <Slider {...settings}>
